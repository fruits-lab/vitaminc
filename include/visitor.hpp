...
struct NegExprNode;
struct AddrExprNode;
struct DereferExprNode;
struct NotExprNode;
struct BitCompExprNode;
...
class Visitor {
 public:
  ...
  virtual void Visit(CondMut<IncrExprNode>&){};
  virtual void Visit(CondMut<DecrExprNode>&){};
  virtual void Visit(CondMut<NegExprNode>&){};
  virtual void Visit(CondMut<AddrExprNode>&){};
  virtual void Visit(CondMut<DereferExprNode>&){};
  virtual void Visit(CondMut<NotExprNode>&){};
  virtual void Visit(CondMut<BitCompExprNode>&){};
